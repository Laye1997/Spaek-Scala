...
object Main_Exo1 extends App {
  ...
  Question1:
  1-) L'avantage de la Programmation Scala:
  Scala regroupe un ensemble de de caractéristiques trés intéressantes:
  la simplicité de sa syntaxe et du paradigme des programmations orientée objet et fonctionnelle.


  Question 2:
  2-) Interprétaton des instructions suivantes:
  var a=1 //ou var a:Int=1 a est une variable, int pour le type dela variable
  val b=2; b est une constante
  final val c=4 final permet de faire de la programmation fonctionnelle avec des données non mutables
  et eviter les derivees. ici affecte c la valeur 4 immutable

  private final val e=3 visible que par les instance de cette classe
  lazy val name ="fall l'expression fall n'est pas imediatement utilisé mais lors du premier accès
   */

  //Question 3:
  //3-L’initialisation d’une variable peut etre optimiser par Option[Type]
  ...
  /*
  Question 4:
  Definition polymorphisme et exemple
  C'est l'un des concept les plus importants de l'orienté objet.
  ...
  */
  ...
  /*
  Question 5
  Comment appel-ton le mécanisme d' incorporer une référence dans une chaîne de caractère
  ...
  */
  ...
  /*
  Question 7
  l'avantage des lambda expression
  Lorsqu'on utilise une fonction simple, les lambda expressions sont plus pratiques au meme endroit
  ...
  //Question13
  //Dresser un tableau qui compare une case class et class simple
  ...
  /*
  Question 15
  L'encapsulation est un processus d'embellage de code et de données
  ...
  */
  ...
  /*
  Question16
  Analysons la classe suivante
  proposons une solution pour les accès et les modifications de son état

  class Person(var nom:String, val prenom :String, idcni:Int, private var age :Int)

  On a déclaré la variable nom et la contante prénom étant plublique et accessible.
...
*/
  ...
  /*
  Question18
  C'est un object dont le nom es le meme que celui de la classe.
